...
class Interactions(object):
    ...
    def to_sequence(self, max_sequence_length=10, min_sequence_length=None, step_size=None):
        ...
        if 0 in self.item_ids:
            raise ValueError(
                "0 is used as an item id, conflicting " "with the sequence padding value."
            )
        ...
        return SequenceInteractions(
            sequences, user_ids=sequence_users, num_items=self.num_items
        )
...
class SequenceInteractions(object):
    ...
    def __init__(self, sequences, user_ids=None, num_items=None):
    ...
    def __repr__(self):
        ...
        return (
            "<Sequence interactions dataset ({num_sequences} "
